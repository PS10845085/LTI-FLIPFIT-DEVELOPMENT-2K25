...
public class GymFlipFitOwnerController {
	...
	@RequestMapping(value = "/createOwner", produces = MediaType.APPLICATION_JSON, method = RequestMethod.POST)
	...
	@RequestMapping(value = "/updateOwner/{id}", produces = MediaType.APPLICATION_JSON, method = RequestMethod.PUT)
	...
	@RequestMapping(value = "/deleteOwner/{id}", produces = MediaType.APPLICATION_JSON, method = RequestMethod.DELETE)
